...
copy_example "$CAREER_DIR/identity.example.yml"        "$CAREER_DIR/identity.yml"
...
echo "  1. Edit $CAREER_DIR/identity.yml    — 填你的 name / email / phone / links"
echo "  2. Edit $CAREER_DIR/preferences.yml — 填你的目标岗位 / comp / hard_filters"
echo "  3. Edit $CAREER_DIR/portals.yml     — 定制你想扫的公司和 GitHub repo"
echo "  4. Edit $CAREER_DIR/qa-bank/legal.yml — 填你的 visa / EEO 等法律答案"
echo ""
